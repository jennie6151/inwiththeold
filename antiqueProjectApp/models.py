...
class Antique(models.Model):
    ...
    AntiqueImage = models.CharField(max_length=200, null=True, blank=True)
...
class AntiqueSale(models.Model):
    ...
    customerEmail = models.CharField(max_length=200, null=False)
    customerTelephone = models.CharField(max_length=20, null=False)
